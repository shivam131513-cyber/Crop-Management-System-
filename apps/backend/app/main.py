...
from app.routers import crop, weather, pest, pest_alert, soil, market, auth, water, rotation, analytics, notifications, export_data, scheme
...
app.include_router(pest_alert.router, prefix="/pest",    tags=["Pest Detection"])
